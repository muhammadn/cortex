...
import (
	...
	client "github.com/muhammadn/cortex/pkg/ingester/client"
...
type Series struct {
	...
	Labels      []github_com_cortexproject_cortex_pkg_cortexpb.LabelAdapter `protobuf:"bytes,3,rep,name=labels,proto3,customtype=github.com/muhammadn/cortex/pkg/cortexpb.LabelAdapter" json:"labels"`
